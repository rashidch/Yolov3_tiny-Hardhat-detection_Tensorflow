...
# some paths
parser.add_argument("--eval_file", type=str, default="./data/my_data/test.txt",
                    help="The path of the validation or test txt file.")

parser.add_argument("--restore_path", type=str, default="./checkpoint/yolov3_tiny_hardhat/model-step_6000_loss_1.212937_lr_0.0008153726",
...
#print("y_true_13***************************", y_true_13)
#print("y_true_26****************************", y_true_26)
if (net_name == 'yolov3_tiny'):  
